...
const cards = [
  {
    ...
    title: "I'm hiring",
    body: "Post free. Get a vetted shortlist in 24 hours. Optional 2-day trial.",
    points: [
      "Small shortlist, not a resume pile",
      "Try before you hire",
      "Payroll and onboarding handled",
    ],
  ...
  },
  {
    ...
    body: "Create one profile and get matched to remote tech roles we’re filling.",
    points: [
      "One profile for AI, Cloud, DevOps, and more",
      "Matched seats, not a spam apply wall",
